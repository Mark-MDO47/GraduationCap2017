...
const int8_t ptrnDownTheDrainIn[] = { SUPRSPCL_SKIP_STEP1, STEP2_DRAIN_IN_DOWN, SUPRSPCL_END_OF_PTRNS };
const int8_t ptrnUpTheDrainIn[] =   { SUPRSPCL_SKIP_STEP1, STEP2_DRAIN_IN_UP,   SUPRSPCL_END_OF_PTRNS };
...
const int8_t ptrnRingDraw[] = { /*SUPRSPCL_STOP_WHEN_DONE, */ SUPRSPCL_SKIP_STEP1, 
   ...
   // STEP2_FADEDISK2_CLR_BKGND, STEP2_FADEDISK2_CLR_FRGND, STEP2_FADEDISK2_CLR_BLNKNG, STEP2_FADEDISK2_CLR_BLACK, 
   SUPRSPCL_END_OF_PTRNS };
