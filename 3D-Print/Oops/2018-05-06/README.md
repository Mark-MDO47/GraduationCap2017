...
The partial print was usable to do a fit-check of some parts.
  493 thru 495

Hmm - comment of "that doesn't look good!!!" gets turned by bash into "that doesn't look goodgit status!".
A bit of an information leak there... not too bad this time.
